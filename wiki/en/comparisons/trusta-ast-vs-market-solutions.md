...
> This project only benchmarks "its own" numbers, measured in-house.
...
- **This service's tok/s / TTFT / load time, and VRAM reduction (before vs. after offload)**: measured in-house.
